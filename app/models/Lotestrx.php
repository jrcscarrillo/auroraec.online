...
// **********************
    ...
    public function existenciasGrupo($params, $stmt) {
        ...
        $phql = 'SELECT I.parent_reference_listid, I.quickbooks_listid FROM items AS I INNER JOIN lotestrx AS L ON L.ItemRef_ListID = I.quickbooks_listid '
                . ' WHERE L.OrigenTrx ="' . $bodega . '" OR L.DestinoTrx = "' . $bodega . '" AND I.parent_reference_listid = "' . $producto . '" AND L.TxnDate < "' . $iniDate . '";';
        $in_outs = $stmt->fetchAll($phql);
