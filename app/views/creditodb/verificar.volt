        ...
        <div class="l-row">
            ...
            <div class="l-col-12">
                <div class="form-body pad-0">
                    {{ form('creditodb/firmar/' ~ paraforma['numeronotacr'], 'method': 'post') }}
                    <fieldset>
                        ...
                        <div class="l-row">
                            <div class="l-col-12">
                                <table class="table coqueirosy table-responsive table-bordered table-striped table-hover" align="center">
                                    <thead>
                                        {% if paraforma['tipoitem'] === 'Assembly' %}
                                        ...
                                        {% endif %}
                                        {% if paraforma['tipoitem'] === 'Service' %}
                                            <tr  class="table-active">
                                                <th style="font-size:120%; color:#686868; text-align:center;">Producto</th>
                                                <th class="tb-c10" style="font-size:120%; color:#686868; text-align:center;">ValorCR</th>
                                                <th class="tb-c10" style="font-size:120%; color:#686868; text-align:center;">Valor</th>
                                        ...
                                        {% for lineas in productos %}
                                            ...
                                            {% if paraforma['tipoitem'] === 'Service' %}
                                                <tr>
                                                    ...
                                                    <td style="text-align:right;"> {{ lineas['Rate'] | number_format(2, ',', '.') }} </td>
                                                ...
                                                {% set ivaCR = ivaCR + (12/100 * lineas[campo3] )  %}
                                                {% set totalCR = subtotalCR + ivaCR %}
                                                {% set subtotal = subtotal +  lineas['Rate'] %}
                                                {% set iva = iva + (12/100 * lineas['Rate'] )  %}
                                                {% set total = subtotal + iva %}
                                            {% endif %}
                                            {% set l = l + 1 %}
                                        {% endfor %}     
