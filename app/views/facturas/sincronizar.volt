                    ...
                    <tr>
                        ...
                        <td width="51%" class="izq">
                            ...
                            <div style="color:#A52A2A; font-size:24px; text-align:left; font-weight: bold;">RUC :
                                ...
                                <span style="color:#B8860B; font-size:24px; text-align:left; font-weight: bold;"> {{ invoice.getTxnID() }} </span></div>
                                <hr>
                        </td>
                    </tr><tr></tr>
                    <tr><td>
                    ...
                    <tbody>
                        {% for producto in productos %}
                            <tr>
                                ...
                                <td align="right"> {{ producto.Rate | number_format(2, ',', '.') }} </td>
                        ...
                        {% endfor %}
                            ...
                            <tr>
                                <td class="blanktotal" colspan="4" rowspan="6">
                                    ...
                                    <div style="color:#B8860B; font-size:12px; text-align:left; font-weight: bold;">OBSERVACIONES : {{ invoice.getCustomField3() }} </div>
                                  {{ link_to("facturas/search/" ~ ' ', 'Regresar a Busqueda', "class": "btn btn-primary") }}
                                </td>
