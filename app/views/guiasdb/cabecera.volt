                            ...
                            <div class="l-row">
                                <div class="l-col-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="l-pos-r">
                                            {{ form.render("refNumber", ['class': 'form-element form-element-icon', 'id':'refNumber', 'name':'refNumber', 'readonly':'readonly' ]) }}
                            ...
                            <div class="l-row">
                                ...
                                <div class="l-col-4">
                                    ...
                                    <div class="form-group form-group-select" data-icon="&#xf078">
                                        ...
                                        <label for="destinoId"> CLIENTE DESTINO : </label>

                                        <div class="l-pos-r">

                                            {{ form.render('destinoId', ['class': 'form-element form-element-icon multi-select', 'readonly':'readonly' ]) }}
                                            <i class="fa fa-file-text-o fa-absolute fa-background"></i>
                                        </div>
