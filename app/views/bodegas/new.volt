...
{{ content() }} {{ form("bodegas/create", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
...
<div class="form-group">
    <label for="fieldBodegaaddress" class="col-sm-2 control-label">BodegaAddress</label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="fieldContacto" class="col-sm-2 control-label">Contacto</label>
    <div class="col-sm-10">
