<div class="row">
    <nav>
        <ul class="pager">
            <li class="previous">{{ link_to("creditmemo", "Go Back") }}</li>
        </ul>
    </nav>
</div>
...
{{ form("creditmemo/create", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
...
<div class="form-group">
    <label for="fieldCreditremaining" class="col-sm-2 control-label">CreditRemaining</label>
    <div class="col-sm-10">
        {{ text_field("CreditRemaining", "type" : "numeric", "class" : "form-control", "id" : "fieldCreditremaining") }}
    </div>
</div>
...
<div class="form-group">
    <label for="fieldCreditremaininginhomecurrency" class="col-sm-2 control-label">CreditRemainingInHomeCurrency</label>
    <div class="col-sm-10">
        {{ text_field("CreditRemainingInHomeCurrency", "type" : "numeric", "class" : "form-control", "id" : "fieldCreditremaininginhomecurrency") }}
    </div>
</div>
