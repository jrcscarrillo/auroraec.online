...
<div style="background-color: #C1C1C1">
    <div class="row full-width">
        <div class="col-md-6">
            <div align="right">
                {{ link_to("customer/new", "Agregar un Cliente", "class": "btn btn-warning") }}
            </div>
            {{ form('customer/search', 'role': 'form', 'class': 'sky-form') }}
            ...
            <footer>
                ...
                <p class="help-block">Puede buscar un cliente o varios con la misma caracteristica.</p>
            </footer>
            </form>
        </div>
