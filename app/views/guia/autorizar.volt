...
<div class="container mt-3">
            ...
            <table class="table" width="100%">
                <tr>
                    <td width="100%" class="izq">
                        <div style="color:#A52A2A; font-size:14px; text-align:left; font-weight: bold;">Envio de Guia al SRI                    : 
                            <span style="color:#B8860B; font-size:14px; text-align:left; font-weight: bold;"> {{ nombres['recibida'] }} </span></div>
                        <div style="color:#A52A2A; font-size:14px; text-align:left; font-weight: bold;"> Mensaje de error              : 
                            <span style="color:#B8860B; font-size:14px; text-align:left; font-weight: bold;"> {{ nombres['errorrecepcion'] }} </span></div>
                        <div style="color:#A52A2A; font-size:14px; text-align:left; font-weight: bold;">Autorizacion del SRI                                             : 
                            <span style="color:#B8860B; font-size:14px; text-align:left; font-weight: bold;">{{ nombres['autorizado'] }} </span></div>
                        <div style="color:#A52A2A; font-size:14px; text-align:left; font-weight: bold;">Mensaje de error                                 : 
                            <span style="color:#B8860B; font-size:14px; text-align:left; font-weight: bold;"> {{ nombres['errorautorizado'] }} </span></div>
                        <div style="color:#A52A2A; font-size:14px; text-align:left; font-weight: bold;">Numero Autorizacion                                      : 
                            <span style="color:#B8860B; font-size:14px; text-align:left; font-weight: bold;">{{ nombres['numeroautorizacion'] }} </span></div>
                        <div style="color:#A52A2A; font-size:14px; text-align:left; font-weight: bold;">Fecha Autorizacion                                     : 
                            <span style="color:#B8860B; font-size:14px; text-align:left; font-weight: bold;"> {{ nombres['fechaautorizacion']  }} </span></div>
                    </td>
                </tr>
            </table>                
    ...
    <div class="row">
        <div class="form-group">
            {{ link_to("guia/search/", 'Regresa a Buscar', "class": "btn btn-success") }}
        </div>
    </div>
